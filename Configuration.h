...
// Adding Tronxy Base defines  <Trx 17.07>
// Start
...
#elif ENABLED(SKR_MINI_E3_V3_0)
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V3_0
  #define Stepper_4
  #define S_TMC2209
#endif

#if ENABLED(S_TMC2209)
...
// Author info of this build printed to the host during boot and M115  <Trx 17.07>
#define STRING_CONFIG_H_AUTHOR "(BigTree-Tronxy, SKR_MINI_E3_V3_0)" // Who made the changes.
...
// Name displayed in the LCD "Ready" message and Info menu  <Trx 17.07>
#define CUSTOM_MACHINE_NAME "Tronxy-SKR Mini e3 V3"
...
//#define PSU_NAME "Power Supply"
  ...
  //#define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    //#define AUTO_POWER_E_TEMP        50 // (°C) Turn on PSU if any extruder is over this temperature <Trx 20.07>
    //#define AUTO_POWER_CHAMBER_TEMP  30 // (°C) Turn on PSU if the chamber is over this temperature  <Trx 20.07>
    //#define AUTO_POWER_COOLER_TEMP   26 // (°C) Turn on PSU if the cooler <Trx 20.07>
 ...
 * ================================================================
 *    -5 : PT100 / PT1000 with MAX31865 (only for sensors 0-1)  <Trx 17.07>
...
//  #define MAX31865_SENSOR_OHMS_0      100 // (Ω) Typically 100 or 1000 (PT100 or PT1000)   <Trx>
//  #define MAX31865_CALIBRATION_OHMS_0 430 // (Ω) Typically 430 for Adafruit PT100; 4300 for Adafruit PT1000
#endif
#if TEMP_SENSOR_IS_MAX_TC(1)
//  #define MAX31865_SENSOR_OHMS_1      100  // <Trx>
...
// Use temp sensor 1 as a redundant sensor with sensor 0. If the readings <Trx 17.07>
// from the two sensors differ too much the print will be aborted.
// #define TEMP_SENSOR_1_AS_REDUNDANT
// #define TEMP_SENSOR_REDUNDANT_MAX_DIFF 10 // <Trx>
...
//#if TEMP_SENSOR_CHAMBER  <Trx - No chamber >
...
#define BED_MAXTEMP      100 //125  <Trx 17.07> 
 ...
 */
 #define PIDTEMP           // See the PID Tuning Guide at https://reprap.org/wiki/PID_Tuning <Trx 20.07 >
...
// <M303 10.26.2023>																								 
#define DEFAULT_bedKp 239.27 
#define DEFAULT_bedKi 46.01
#define DEFAULT_bedKd 829.48
  
  // 120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  // from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
  // #define DEFAULT_bedKp 10.00
  // #define DEFAULT_bedKi .02
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_FUNCTIONAL_RANGE 1 // Trx Set to 2 orginally 10
...
// @section safety - extruder <Trx 18.07>
...
#define EXTRUDE_MAXLENGTH 800  //<Trx 18.07> original = 600
...
// Define Tronxy CoreXY entry
//#define COREXY     //<Trx 18.07>
//#define COREXZ
//#define COREYZ       
#define COREYX       // <Trx 13.8 >
//#define COREZX
//#define COREZY
...
#define X_MIN_ENDSTOP_HIT_STATE LOW   //  HIGH < Trx >
#define X_MAX_ENDSTOP_HIT_STATE HIGH   
#define Y_MIN_ENDSTOP_HIT_STATE LOW   //  HIGH < Trx >
#define Y_MAX_ENDSTOP_HIT_STATE HIGH
#define Z_MIN_ENDSTOP_HIT_STATE HIGH   
#define Z_MAX_ENDSTOP_HIT_STATE LOW   //  HIGH < Trx >
 ...
 */
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 430.1 } // 90.3
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 430.1 }  //< Trx 20.07>
...
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 5000 }  // <Trx>
...
*/
#define DEFAULT_ACCELERATION          1500    // X, Y, Z and E acceleration for printing moves <trx>
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.013  // (mm) Distance from real junction edge  {orn. 0.08} <Trx>
 ...
 */
// #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  //<Trx now with 3d probe>

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING  // <Trx use the probe as the Z_MIN
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47.1, -23.1, -2.3 }  // <Trx>
...
#define PROBING_MARGIN 15  // <Trx> 10 org  
...
#define INVERT_E0_DIR false  // <Trx was true, need false  
...
// The size of the printable area  <org 235 Trx>
#define X_BED_SIZE 330
#define Y_BED_SIZE 320
#define Z_MAX_POS 400  // orgt. 250  <Trx>
 ...
 */
#define FILAMENT_RUNOUT_SENSOR  // <Trx org. disable  <Trx>
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.

  #define FIL_RUNOUT_STATE    HIGH  //<trx>  LOW        // Pin state indicating that filament is NOT present.
...
#define AUTO_BED_LEVELING_BILINEAR  // <Trx>
//#define AUTO_BED_LEVELING_UBL
//#define MESH_BED_LEVELING  <Trx>
 ...
 */
#define RESTORE_LEVELING_AFTER_G28   // <Trx>
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 40, 30, 30, 20 } // (mm) Left, Front, Right, Back insets
...
//#define SKEW_CORRECTION
  ...
  #define XY_SKEW_FACTOR 0.0  <enabled Trx>
  ...
  //#define SKEW_CORRECTION_FOR_Z
    ...
    // Or, set the Z skew factors directly: <enabled, Trx>
...
#define PREHEAT_1_TEMP_HOTEND 180  //<org 185 Trx>
#define PREHEAT_1_TEMP_BED     70  //<org 45 Trx>
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED   0 // Value from 0 to 255 org. 255 <Trx>

#define PREHEAT_2_LABEL       "ABS"
#define PREHEAT_2_TEMP_HOTEND 240
#define PREHEAT_2_TEMP_BED    110
#define PREHEAT_2_TEMP_CHAMBER 35
#define PREHEAT_2_FAN_SPEED   0 // Value from 0 to 255  org. 255 <Trx>
