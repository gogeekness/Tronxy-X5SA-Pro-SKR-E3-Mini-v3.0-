...
#define CONFIG_EXAMPLES_DIR "Trox/BigTreeTech SKR Mini E3 3.0"
 ...
 */
  ...
  #define WATCH_TEMP_INCREASE 12               // Degrees Celsius
#endif
...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN FAN1_PIN       // Set a custom pin for the controller fan  // <Trx>
 ...
 */
// #define E0_AUTO_FAN_PIN FAN1_PIN <TRx>
...
#define COOLER_AUTO_FAN_TEMPERATURE 25  // Matrial cooler
#define COOLER_AUTO_FAN_SPEED 255  // 255 == full speed
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // <trx> Add a Probe Z Offset calibration option to the LCD menu
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define LONG_FILENAME_WRITE_SUPPORT   // <Trx> Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  //#define SCROLL_LONG_FILENAMES           // <TRx> Scroll long filenames in the SD card menu
   ...
   */
   ...
   #define SDCARD_CONNECTION LCD // <Trx>
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_WITHOUT_HOMING           // <TRX>
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement) <Trx>
  //#define BABYSTEP_XY                     // Also enable X/Y Babystepping. Not supported on DELTA!
  #define BABYSTEP_INVERT_Z               // <TRX Z is inverted > Enable if Z babysteps should go the other way
  #define BABYSTEP_MILLIMETER_UNITS       // <TRX visual addon> Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps
  #define BABYSTEP_MULTIPLICATOR_Z  0.01       // <TRX> (steps or mm) Steps or millimeter distance for each Z babystep
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // <Trx> Combine M851 Z and Babystepping
  //#define BABYSTEP_GLOBAL_Z               // Combine M424 Z and Babystepping
    ...
    #endif
    #define BABYSTEP_GFX_OVERLAY          // Enable graphical overlay on Z-offset editor <Trx>
  #endif
#endif
 ...
 */
#define G29_RETRY_AND_RECOVER  // <TRX>
...
// <TRX> added extended Buffer support for larger sizes
...
#define TX_BUFFER_SIZE 128  //<TRX orgional -> 0 >
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      800  // <Trx oringinal 400 > (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   800  // <Trx oringinal 350> (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define FILAMENT_UNLOAD_ALL_EXTRUDERS         // <TRX> Allow M702 to unload all extruders above a minimum target temp (as set by M302)
#endif
 ...
 */
  ...
  // DID NOT CHANGE AS DIFFERENT DRIVERS <TRX>
    ...
    #define E0_CURRENT      700  // <Org 650 Trx>
   ...
   */
  #define HYBRID_THRESHOLD  // <Trx>

  #define X_HYBRID_THRESHOLD     100  // [mm/s]
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     100
  #define Y2_HYBRID_THRESHOLD    100
  #define Z_HYBRID_THRESHOLD      15  // Org 03  <Trx> 
